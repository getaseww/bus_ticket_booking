                ...
                while($row=$result->fetch_array()){
                    echo "<tr>
                                ...
                                if ($row['status']=='pending') {
                                  echo '<td>';
                                  echo  '<form method="POST" action="accept-reservation.php"  class="register-form">
                                          <input type="hidden" name="res_id" class="form-control" id="res_id" value="';echo $row['id']; echo '">           
                                          <button type="submit" name="approval" class="btn btn-primary">Accept</button>
                                        </form>';
                                        echo  '<form method="POST" action="decline-reservation.php"  class="register-form">
                                        <input type="hidden" name="res_id" class="form-control" id="res_id" value="';echo $row['id']; echo '">           
                                        <button type="submit" name="approval" class="btn btn-danger">Decline</button>
                                        </form>
                                        </td>';
                                ...
                                echo '<td><form method="POST" action="decline-reservation.php"  class="register-form">
                                <input type="hidden" name="res_id" class="form-control" id="res_id" value="';echo $row['id']; echo '">           
